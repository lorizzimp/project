...
<head>
<meta charset="utf-8">
<title>ระบบจองห้องประชุมlogin</title>
...
<table width="971" height="852" border="0" align="center">
  <tbody>
    ...
    <tr>
      ...
      <td colspan="2" rowspan="4" align="center" valign="middle"><img src="image/login-icon1.jpg" width="417" height="288" alt=""/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="378" rowspan="2" align="center" valign="top"><input name="submit" class="btn btn-primary" type="submit" id="submit" value="ยืนยัน"></td>
      <td width="386" rowspan="2" align="center" valign="top"><input type="button" class="btn btn-danger" name="button" id="button" value="ยกเลิก"></td>
    </tr>
